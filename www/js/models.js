...
var Story = Backbone.Model.extend({
  ...
  setupTopic: function() {
    ...
    var topic = CampusReporter.topics.get(this.get('topic'));
  ...
  share: function() {
    ...
    if (pending.length > 0) {
      if (!confirm(CampusReporter.polyglot.t('story.share_incomplete')))
        return;
    }
    ...
    CampusReporter.trackEvent('story', 'share');
  }
});
