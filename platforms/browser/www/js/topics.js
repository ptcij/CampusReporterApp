...
var STORYCHECK_TOPICS = [
  {
    ...
    "questions": [
      ...
      {
        "key": "8",
        "question": "Was the News conference aired Live?"
      },
      {
        "key": "9",
        "question": "Were agitators or a specific group of reporters barred from gaining access to the names and job to the venue of the News Conference?"
      },
      {
        "key": "10",
        "question": "Was there any display of high-handedness on the part of security operatives against reporters during or after the event?"
      }        
    ]
  },
  {
    ...
    "questions": [
      ...
      {
        "key": "12",
        "question": "Tip: Ensure the ushers at the event identify you as a reporter before the event, so you could be ushered to the section designated for the Press and receive useful handouts such as copies of speech and order of programme"
      },
      {
        "key": "13",
        "question": "Tip: Note any discrepancy (especially in figures) between what is contained in the hard copy of the speech (handout) and what the speaker delivered, with a view to drawing his/her attention to it for clarification during the question and answer session"
      },
      {
        "key": "14",
        "question": "What point(s) of the speech drew more questions from participants/audience during the question and answer session?"
      },
      {
        "key": "15",
        "question": "At what point(s) during the speech was a remark greeted by ovation or disapproval from the audience?"
      }
    ]
  },
  {
    ...
    "questions": [
      ...
      {
        "key": "17",
        "question": "Tip: Do not be tempted to act in solidarity with the protesters as this would drown your sense of objectivity and set you on a collision course with security operatives who may brand you as one of the protesters (If the March was not sanctioned)"
      },
      {
        "key": "18",
        "question": "Tip: Observe placards brandished by protesters and pay attention to their songs of solidarity (If any)"
      },
      {
        "key": "19",
        "question": "Are the agitations expressed on placards and in songs in tandem with the motive(s) earlier projected by the organizers?"
      },
      {
        "key": "20",
        "question": "Did any Executive or Government official arrive at the scene of the protest with an attempt to appeal for calm and dispersal?"
      },
      {
        "key": "21",
        "question": "Was the protest hijacked by a group different from the organizers? Check with the organizers for confirmation or denial?"
      }
    ]
  },
  {
    ...
    "questions": [
      ...
      {
        "key": "19",
        "question": "Tip: Record the plate registration number of the vehicles involved"
      },
      {
        "key": "20",
        "question": "Tip: Where commercial vehicle(s) is/are involved, endeavor to ascertain if there was a travel-manifest (containing names of passengers, their phone numbers, next of kin and destination)"
      },
      {
        "key": "21",
        "question": "Did the accident cause a traffic gridlock? How long did it last?"
      },
      {
        "key": "22",
        "question": "Where Road Safety or officers of other emergency agencies quick to arrive at the scene?"
      },
      {
        "key": "23",
        "question": "Does the road or exact spot of the accident have a history of automobile crashes? Check with Road Safety officials and residents nearby for confirmation"
      }
    ]
  },
  {
