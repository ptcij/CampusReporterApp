var L10N = {
  "en-za": {
    "about": {
      ...
      "line1": "Campus Reporter is a news editor in your pocket that helps you be a better reporter.", 
      "line2": "Simply answer the questions as Campus Reporter guides you through the news gathering process.", 
      "title": "About Campus Reporter"
    }, 
    "name": "English", 
    "nav": {
      "about": "About", 
    ...
    "splash": {
      "description": "Campus Reporter helps you be a<br>better reporter by guiding you<br>through the news gathering process.", 
    ...
    "topics": {
      "1": {
        ...
        "questions": {
          ...
          "10": "Was there any display of high-handedness on the part of security operatives against reporters during or after the event?",    
      ...
      "2": {
        ...
        "questions": {
          ...
          "12": "Tip: Ensure the ushers at the event identify you as a reporter before the event, so you could be ushered to the section designated for the Press and receive useful handouts such as copies of speech and order of programme",
          "13": "Tip: Note any discrepancy (especially in figures) between what is contained in the hard copy of the speech (handout) and what the speaker delivered, with a view to drawing his/her attention to it for clarification during the question and answer session",
          "14": "What point(s) of the speech drew more questions from participants/audience during the question and answer session?",
          "15": "At what point(s) during the speech was a remark greeted by ovation or disapproval from the audience?",
      ...
      "3": {
        ...
        "questions": {
          ...
          "17": "Tip: Do not be tempted to act in solidarity with the protesters as this would drown your sense of objectivity and set you on a collision course with security operatives who may brand you as one of the protesters (If the March was not sanctioned)", 
          "18": "Tip: Observe placards brandished by protesters and pay attention to their songs of solidarity (If any)", 
          "19": "Are the agitations expressed on placards and in songs in tandem with the motive(s) earlier projected by the organizers?", 
          "2": "What kind of protest is it? A march, a strike, a barricade?",
          "20": "Did any Executive or Government official arrive at the scene of the protest with an attempt to appeal for calm and dispersal?", 
          "21": "Was the protest hijacked by a group different from the organizers? Check with the organizers for confirmation or denial?",                 
      ...
      "4": {
        ...
        "questions": {
          ...
          "19": "Tip: Record the plate registration number of the vehicles involved", 
          "2": "Were any people injured or dead and how many?", 
          "20": "Tip: Where commercial vehicle(s) is/are involved, endeavor to ascertain if there was a travel-manifest (containing names of passengers, their phone numbers, next of kin and destination)", 
          "21": "Did the accident cause a traffic gridlock? How long did it last?", 
          "22": "Where Road Safety or officers of other emergency agencies quick to arrive at the scene?",
          "23": "Does the road or exact spot of the accident have a history of automobile crashes? Check with Road Safety officials and residents nearby for confirmation", 
