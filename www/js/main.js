...
var Router = Backbone.Router.extend({
  ...
  track: function() {
    ...
    CampusReporter.trackView(fragment);
  }
});


/*** Globals ***/
var CampusReporter = Backbone.Model.extend({
  initialize: function() {
    var self = this;
  ...
  load: function() {
    ...
    if (this.storage) {
      val = this.storage.getItem('CampusReporter');
  ...
  save: function() {
    if (this.storage) {
      this.storage.setItem('CampusReporter', JSON.stringify(this.state.toJSON()));
    }
  },
...
var app = {
  ...
  eventReceived: function(id) {
    CampusReporter = new CampusReporter();
    router = new Router();
